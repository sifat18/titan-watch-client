...
const Banner = () => {
  return (
    ...
    <Container fluid className=" banner-body">
      <Container
        data-aos="fade-left"
        className="d-flex flex-column justify-content-center align-items-center  mt-5 pt-2"
      >
        <img
          data-aos="fade-left"
          src={pic6}
          ...
          width="250"
        />{" "}
        {/* <img src={pic6} alt="" className='bg-dark' /> */}
        <h2 data-aos="fade-right" className="banner-header">
          what's ticking?
        </h2>
        <p data-aos="fade-up" className="banner-sub">
          We Craft For Your Class
        </p>
        <p data-aos="fade-down" className="banner-sub">
          Time is What You Make Of It. Fashion That Ticks. You Have a Second
          Home, Why Not a Second Watch?
        </p>
      </Container>
      ...
      >
        <path
          fill="#050505"
          fill-opacity="1"
          d="M0,224L48,234.7C96,245,192,267,288,245.3C384,224,480,160,576,128C672,96,768,96,864,117.3C960,139,1056,181,1152,170.7C1248,160,1344,96,1392,64L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
        ></path>
      </svg>
