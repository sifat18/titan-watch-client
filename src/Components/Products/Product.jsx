...
import "../Home/HomeProduct/homeProduct.css";
import pic1 from "../Home/HomeProduct/icons8-watch-64.png";
import pic2 from "../Home/HomeProduct/icons8-return-purchase-64.png";
import ProductSkeleton from "../Skeletons/ProductSkeleton";

const Product = ({ data, padding = "10em" }) => {
  return (
    <Container
      data-aos="fade-left"
      fluid
