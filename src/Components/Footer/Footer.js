...
import "./footer.css";
import footImg from "./icons8-watch-64.png";
    ...
    <Container fluid className="footer  ps-5">
      <Row className="mt-5 pt-5">
        ...
        <Col xs={12} md={6}>
          <Row>
            {/* footer notes */}
            <Col xs={12} md={6} className="mb-5 product-extra">
              <p>About us</p>
              <p>Our Services</p>
            ...
            <Col
              xs={12}
              md={6}
              className="d-flex flex-column align-items-center justify-content-center product-extra"
            >
              <p>Follow us at</p>
